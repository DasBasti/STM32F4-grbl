...
#define DEFAULT_X_STEPS_PER_MM (20.0f * 25)
#define DEFAULT_Y_STEPS_PER_MM (20.0f * 25)
...
#define DEFAULT_X_MAX_RATE 100000.0f // mm/min
#define DEFAULT_Y_MAX_RATE 100000.0f // mm/min
#define DEFAULT_Z_MAX_RATE 7300.0f // mm/min
#define DEFAULT_A_MAX_RATE 600.0f // mm/min
#define DEFAULT_B_MAX_RATE 600.0f // mm/min
#define DEFAULT_X_ACCELERATION (1000.0f*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
#define DEFAULT_Y_ACCELERATION (1000.0f*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
#define DEFAULT_Z_ACCELERATION (90.0f*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
#define DEFAULT_A_ACCELERATION (90.0f*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
#define DEFAULT_B_ACCELERATION (90.0f*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
#define DEFAULT_X_MAX_TRAVEL 400.0f // mm NOTE: Must be a positive value.
#define DEFAULT_Y_MAX_TRAVEL 500.0f // mm NOTE: Must be a positive value.
...
#define DEFAULT_STEP_PULSE_MICROSECONDS 250
#define DEFAULT_STEPPING_INVERT_MASK 0
...
#define DEFAULT_HOMING_SEEK_RATE 50000.0f // mm/min
#define DEFAULT_HOMING_DEBOUNCE_DELAY 250 // msec (0-65k)
